...
const API_HOST = "https://%s.staging.internetofthings.ibmcloud.com/api/v0002";
...
export default class ApplicationClient extends BaseClient {
  ...
  publishHTTPS(deviceType, deviceId, eventType, eventFormat, payload){
    ...
    return new Promise((resolve, reject) => {
      let uri = format("https://%s.staging.internetofthings.ibmcloud.com/api/v0002/application/types/%s/devices/%s/events/%s", this.org, deviceType, deviceId, eventType);
